      ...
      '/mcp/': [
        {
          text: '入门基础',
          items: [
            { text: '什么是 MCP', link: '/mcp/getting-started/00-what-is-mcp' },
            { text: '第一次写 MCP Server', link: '/mcp/getting-started/01-first-server' },
            { text: '三大原语初体验', link: '/mcp/getting-started/02-primitives-tour' },
          ]
        },
        {
          text: '协议详解',
          items: [
            { text: '协议总览', link: '/mcp/00-mcp-from-zero' },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Runner 执行器（原理索引）', link: '/trpc-agent-go/examples/02-runner-executor/' },
                { text: 'Runner 运行器', link: '/trpc-agent-go/examples/02-runner-executor/runner' },
                { text: '托管 Runner', link: '/trpc-agent-go/examples/02-runner-executor/managedrunner' },
                { text: '取消运行', link: '/trpc-agent-go/examples/02-runner-executor/cancelrun' },
                { text: '消息运行', link: '/trpc-agent-go/examples/02-runner-executor/runwithmessages' },
                { text: 'Ralph 循环', link: '/trpc-agent-go/examples/02-runner-executor/ralphloop' },
              ]
            },
            {
              text: '02 - 工具系统',
              collapsed: true,
              items: [
                { text: '工具索引', link: '/trpc-agent-go/examples/03-tool-system/tool' },
                { text: '代码执行工具', link: '/trpc-agent-go/examples/03-tool-system/tool-codeexec' },
                { text: '宿主执行工具', link: '/trpc-agent-go/examples/03-tool-system/tool-hostexec' },
                { text: 'OpenViking 工具', link: '/trpc-agent-go/examples/03-tool-system/tool-openviking' },
                { text: 'Web 抓取工具', link: '/trpc-agent-go/examples/03-tool-system/tool-webfetch' },
                { text: '多工具', link: '/trpc-agent-go/examples/03-tool-system/multitools' },
                { text: 'Agent 工具', link: '/trpc-agent-go/examples/03-tool-system/agenttool' },
                { text: '动态 Agent 工具', link: '/trpc-agent-go/examples/03-tool-system/dynamicagenttool' },
                { text: '工具调用 ID', link: '/trpc-agent-go/examples/03-tool-system/toolcallid' },
                { text: '工具过滤', link: '/trpc-agent-go/examples/03-tool-system/toolfilter' },
                { text: '工具中断', link: '/trpc-agent-go/examples/03-tool-system/toolinterrupt' },
                { text: '工具管道', link: '/trpc-agent-go/examples/03-tool-system/toolpipe' },
                { text: '工具策略', link: '/trpc-agent-go/examples/03-tool-system/toolpolicy' },
                { text: 'OpenAPI 工具', link: '/trpc-agent-go/examples/03-tool-system/openapitool' },
                { text: '工具调用重试', link: '/trpc-agent-go/examples/03-tool-system/llmagent_tool_call_retry' },
              ]
            },
            {
              text: '03 - MCP 工具',
              collapsed: true,
              items: [
                { text: 'MCP 索引', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool' },
                { text: 'MCP 主示例', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool-main' },
                { text: 'STDIO 服务端', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool-stdioserver' },
                { text: 'SSE 服务端', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool-sseserver' },
                { text: 'Streamable 服务端', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool-streamableserver' },
                { text: '动态 HTTP 头', link: '/trpc-agent-go/examples/04-mcp-tools/mcptool-httpheaders' },
                { text: 'MCP Broker', link: '/trpc-agent-go/examples/04-mcp-tools/mcpbroker' },
              ]
            },
            {
              text: '04 - Graph 工作流',
              collapsed: true,
              items: [
                { text: 'Graph 索引', link: '/trpc-agent-go/examples/05-graph-workflow/graph' },
                { text: '基础拓扑模式', link: '/trpc-agent-go/examples/05-graph-workflow/graph-topology' },
                { text: '执行控制与检查点', link: '/trpc-agent-go/examples/05-graph-workflow/graph-execution' },
                { text: '中断与恢复', link: '/trpc-agent-go/examples/05-graph-workflow/graph-interrupt' },
                { text: '子图与子 Agent', link: '/trpc-agent-go/examples/05-graph-workflow/graph-subagent' },
                { text: '流式与 IO 约定', link: '/trpc-agent-go/examples/05-graph-workflow/graph-streaming-io' },
                { text: '高级特性', link: '/trpc-agent-go/examples/05-graph-workflow/graph-advanced' },
              ]
            },
            {
              text: '05 - 多 Agent 协作',
              collapsed: true,
              items: [
                { text: '多 Agent 编排', link: '/trpc-agent-go/examples/06-multi-agent/multiagent' },
                { text: 'Team 协作', link: '/trpc-agent-go/examples/06-multi-agent/team' },
                { text: 'Agent 转移', link: '/trpc-agent-go/examples/06-multi-agent/transfer' },
              ]
            },
            {
              text: '06 - Memory 系统',
              collapsed: true,
              items: [
                { text: 'Memory 索引', link: '/trpc-agent-go/examples/07-memory-system/memory' },
                { text: '简单模式（Agentic）', link: '/trpc-agent-go/examples/07-memory-system/memory-simple' },
                { text: '自动模式（Auto）', link: '/trpc-agent-go/examples/07-memory-system/memory-auto' },
                { text: 'Mem0 集成', link: '/trpc-agent-go/examples/07-memory-system/memory-mem0' },
                { text: 'TencentDB 集成', link: '/trpc-agent-go/examples/07-memory-system/memory-tencentdb' },
                { text: '检索对比', link: '/trpc-agent-go/examples/07-memory-system/memory-compare' },
              ]
            },
            {
              text: '07 - Session 管理',
              collapsed: true,
              items: [
                { text: 'Session 索引', link: '/trpc-agent-go/examples/08-session-management/session' },
                { text: '基础 Session', link: '/trpc-agent-go/examples/08-session-management/session-simple' },
                { text: '追加事件', link: '/trpc-agent-go/examples/08-session-management/session-appendevent' },
                { text: '事件限制', link: '/trpc-agent-go/examples/08-session-management/session-eventlimit' },
                { text: 'TTL 过期', link: '/trpc-agent-go/examples/08-session-management/session-ttl' },
                { text: 'Session 钩子', link: '/trpc-agent-go/examples/08-session-management/session-hook' },
                { text: '人格管理', link: '/trpc-agent-go/examples/08-session-management/session-persona' },
                { text: 'Graph 集成', link: '/trpc-agent-go/examples/08-session-management/session-graph' },
              ]
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Skill 基础', link: '/trpc-agent-go/examples/09-agent-skills/skill' },
                { text: '动态 Schema', link: '/trpc-agent-go/examples/09-agent-skills/skilldynamicschema' },
                { text: 'Skill 发现', link: '/trpc-agent-go/examples/09-agent-skills/skillfind' },
                { text: 'Skill 隔离', link: '/trpc-agent-go/examples/09-agent-skills/skillisolation' },
                { text: 'Skill 加载模式', link: '/trpc-agent-go/examples/09-agent-skills/skillloadmode' },
                { text: 'Skill 运行', link: '/trpc-agent-go/examples/09-agent-skills/skillrun' },
                { text: 'Skill 工具激活', link: '/trpc-agent-go/examples/09-agent-skills/skilltoolactivation' },
                { text: 'Skill 工具配置', link: '/trpc-agent-go/examples/09-agent-skills/skilltoolprofile' },
                { text: '结构化输出 Skill', link: '/trpc-agent-go/examples/09-agent-skills/structuredoutputskills' },
              ]
            },
            {
              text: '09 - A2A 协议',
              collapsed: true,
              items: [
                { text: 'A2A 协议（原理索引）', link: '/trpc-agent-go/examples/10-a2a-protocol/' },
                { text: 'A2A ADK', link: '/trpc-agent-go/examples/10-a2a-protocol/a2aadk' },
                { text: 'A2A Agent', link: '/trpc-agent-go/examples/10-a2a-protocol/a2aagent' },
                { text: 'A2A 代码执行', link: '/trpc-agent-go/examples/10-a2a-protocol/a2acodeexecution' },
                { text: 'A2A 多路径', link: '/trpc-agent-go/examples/10-a2a-protocol/a2amultipath' },
                { text: 'A2A 子 Agent', link: '/trpc-agent-go/examples/10-a2a-protocol/a2asubagent' },
              ]
            },
            {
              text: '10 - AG-UI 协议',
              collapsed: true,
              items: [
                { text: 'AG-UI 协议（原理索引）', link: '/trpc-agent-go/examples/11-agui-protocol/' },
                { text: 'A2UI 协议', link: '/trpc-agent-go/examples/11-agui-protocol/a2ui' },
                { text: 'AG-UI 协议', link: '/trpc-agent-go/examples/11-agui-protocol/agui' },
              ]
            },
            {
              text: '11 - 代码执行',
              collapsed: true,
              items: [
                { text: '代码执行', link: '/trpc-agent-go/examples/12-code-execution/codeexecution' },
                { text: '沙箱代码执行', link: '/trpc-agent-go/examples/12-code-execution/sandboxcodeexecution' },
              ]
            },
            {
              text: '12 - 知识检索 RAG',
              collapsed: true,
              items: [
                { text: 'Knowledge 索引', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge' },
                { text: '基础 RAG', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-basic' },
                { text: '查询增强', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-query-enhancer' },
                {
                  text: '重排器',
                  collapsed: true,
                  items: [
                    { text: 'Cohere 重排', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-reranker-cohere' },
                    { text: 'Infinity 重排', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-reranker-infinity' },
                  ]
                },
                {
                  text: '数据源',
                  collapsed: true,
                  items: [
                    { text: '文件源', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-file' },
                    { text: '目录源', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-directory' },
                    { text: 'URL 源', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-url' },
                    { text: '自动源', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-auto' },
                    { text: '定长切分', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-fixed-chunking' },
                    { text: '递归切分', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-recursive-chunking' },
                    { text: 'AST 源', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-sources-ast' },
                  ]
                },
                {
                  text: '特性',
                  collapsed: true,
                  items: [
                    { text: '智能过滤', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-agentic-filter' },
                    { text: '元数据过滤', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-metadata-filter' },
                    { text: '动态管理', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-management' },
                    { text: '文档提取', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-extractor' },
                    { text: '字符清洗', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-transform' },
                    { text: 'GraphRAG', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-graphrag' },
                    { text: '图可视化', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-graphrag-viewer' },
                    { text: '代码上下文引擎', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-code-context-engine' },
                    { text: 'OCR', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-features-ocr' },
                  ]
                },
                {
                  text: '向量库',
                  collapsed: true,
                  items: [
                    { text: 'pgvector', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-vectorstores-postgres' },
                    { text: 'Elasticsearch', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-vectorstores-elasticsearch' },
                    { text: '腾讯 VectorDB', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-vectorstores-tcvector' },
                    { text: 'Milvus', link: '/trpc-agent-go/examples/13-knowledge-rag/knowledge-vectorstores-milvus' },
                  ]
                },
                { text: 'ArXiv 搜索', link: '/trpc-agent-go/examples/13-knowledge-rag/arxivsearch' },
                { text: 'Wiki 搜索', link: '/trpc-agent-go/examples/13-knowledge-rag/wiki' },
                { text: 'WeKnora', link: '/trpc-agent-go/examples/13-knowledge-rag/weknora' },
              ]
            },
            {
              text: '13 - 模型与提供商',
              collapsed: true,
              items: [
                { text: 'Model 索引', link: '/trpc-agent-go/examples/14-model-provider/model' },
                { text: '重试', link: '/trpc-agent-go/examples/14-model-provider/model-retry' },
                { text: '故障转移', link: '/trpc-agent-go/examples/14-model-provider/model-failover' },
                { text: '对冲请求', link: '/trpc-agent-go/examples/14-model-provider/model-hedge' },
                { text: '模型切换', link: '/trpc-agent-go/examples/14-model-provider/model-switch' },
                { text: '模型选择器', link: '/trpc-agent-go/examples/14-model-provider/model-selector' },
                { text: 'Prompt 映射', link: '/trpc-agent-go/examples/14-model-provider/model-promptmap' },
                { text: '批处理', link: '/trpc-agent-go/examples/14-model-provider/model-batch' },
                { text: '提供商', link: '/trpc-agent-go/examples/14-model-provider/provider' },
              ]
            },
            {
              text: '14 - Prompt 与输出',
              collapsed: true,
              items: [
                { text: 'Prompt 管理', link: '/trpc-agent-go/examples/15-prompt-output/prompt' },
                { text: 'Prompt 缓存', link: '/trpc-agent-go/examples/15-prompt-output/promptcache' },
                { text: '占位符', link: '/trpc-agent-go/examples/15-prompt-output/placeholder' },
                { text: '结构化输出', link: '/trpc-agent-go/examples/15-prompt-output/structuredoutput' },
                { text: '输出 Key', link: '/trpc-agent-go/examples/15-prompt-output/outputkey' },
                { text: '输出 Key 状态', link: '/trpc-agent-go/examples/15-prompt-output/outputkeystate' },
                { text: '输出 Schema', link: '/trpc-agent-go/examples/15-prompt-output/outputschema' },
              ]
            },
            {
              text: '15 - 评测与进化',
              collapsed: true,
              items: [
                { text: 'Evaluation 索引', link: '/trpc-agent-go/examples/16-evaluation/evaluation' },
                {
                  text: '评测器',
                  collapsed: true,
                  items: [
                    { text: 'LLM 裁判', link: '/trpc-agent-go/examples/16-evaluation/evaluation-llm' },
                    { text: 'LLM 验证', link: '/trpc-agent-go/examples/16-evaluation/evaluation-llmverifier' },
                    { text: 'ROUGE', link: '/trpc-agent-go/examples/16-evaluation/evaluation-rouge' },
                    { text: '结巴分词', link: '/trpc-agent-go/examples/16-evaluation/evaluation-jieba' },
                    { text: '工具轨迹', link: '/trpc-agent-go/examples/16-evaluation/evaluation-tooltrajectory' },
                    { text: 'Trace 评测', link: '/trpc-agent-go/examples/16-evaluation/evaluation-trace' },
                    { text: '上下文消息', link: '/trpc-agent-go/examples/16-evaluation/evaluation-contextmessage' },
                  ]
                },
                {
                  text: '记录器',
                  collapsed: true,
                  items: [
                    { text: 'EvalSet 录制', link: '/trpc-agent-go/examples/16-evaluation/evaluation-evalsetrecorder' },
                    { text: '内存记录器', link: '/trpc-agent-go/examples/16-evaluation/evaluation-inmemory' },
                    { text: '本地记录器', link: '/trpc-agent-go/examples/16-evaluation/evaluation-local' },
                    { text: 'MySQL 记录器', link: '/trpc-agent-go/examples/16-evaluation/evaluation-mysql' },
                    { text: 'Langfuse', link: '/trpc-agent-go/examples/16-evaluation/evaluation-langfuse' },
                  ]
                },
                {
                  text: '集成与编排',
                  collapsed: true,
                  items: [
                    { text: '回调评测', link: '/trpc-agent-go/examples/16-evaluation/evaluation-callbacks' },
                    { text: '用户模拟', link: '/trpc-agent-go/examples/16-evaluation/evaluation-usersimulation' },
                    { text: '期望 Runner', link: '/trpc-agent-go/examples/16-evaluation/evaluation-usersimulation-expectedrunner' },
                    { text: 'Claude Code', link: '/trpc-agent-go/examples/16-evaluation/evaluation-claudecode' },
                    { text: 'Skill 评测', link: '/trpc-agent-go/examples/16-evaluation/evaluation-skill' },
                    { text: '评测服务', link: '/trpc-agent-go/examples/16-evaluation/evaluation-server' },
                    { text: 'Prompt 迭代', link: '/trpc-agent-go/examples/16-evaluation/evaluation-promptiter' },
                  ]
                },
                { text: '进化优化', link: '/trpc-agent-go/examples/16-evaluation/evolution' },
              ]
            },
            {
              text: '16 - 可观测性',
              collapsed: true,
              items: [
                { text: 'Callbacks 索引', link: '/trpc-agent-go/examples/17-observability/callbacks' },
                { text: '回调基础', link: '/trpc-agent-go/examples/17-observability/callbacks-basic' },
                { text: '鉴权回调', link: '/trpc-agent-go/examples/17-observability/callbacks-auth' },
                { text: '图片工具回调', link: '/trpc-agent-go/examples/17-observability/callbacks-imagetool' },
                { text: '计时回调', link: '/trpc-agent-go/examples/17-observability/callbacks-timer' },
                { text: '遥测', link: '/trpc-agent-go/examples/17-observability/telemetry' },
                { text: 'Token 追踪', link: '/trpc-agent-go/examples/17-observability/tokentracker' },
              ]
            },
            {
              text: '17 - 安全防护',
              collapsed: true,
              items: [
                { text: 'Guardrail 防护', link: '/trpc-agent-go/examples/18-safety-guardrails/guardrail' },
                { text: '人机协作', link: '/trpc-agent-go/examples/18-safety-guardrails/humaninloop' },
                { text: '任务强制', link: '/trpc-agent-go/examples/18-safety-guardrails/todoenforcer' },
              ]
            },
            {
              text: '18 - 搜索与外部集成',
              collapsed: true,
              items: [
                { text: 'DuckDuckGo 搜索', link: '/trpc-agent-go/examples/19-search-integration/duckduckgo' },
                { text: 'Google 搜索', link: '/trpc-agent-go/examples/19-search-integration/google' },
                { text: 'Dify 集成', link: '/trpc-agent-go/examples/19-search-integration/dify' },
                { text: 'n8n 集成', link: '/trpc-agent-go/examples/19-search-integration/n8n' },
                { text: 'Claude Code', link: '/trpc-agent-go/examples/19-search-integration/claudecode' },
                { text: 'Codex', link: '/trpc-agent-go/examples/19-search-integration/codex' },
                { text: 'Email', link: '/trpc-agent-go/examples/19-search-integration/email' },
                { text: 'OpenAI Server', link: '/trpc-agent-go/examples/19-search-integration/openaiserver' },
              ]
            },
            {
              text: '19 - 高级特性',
              collapsed: true,
              items: [
                { text: '上下文压缩', link: '/trpc-agent-go/examples/20-advanced-features/context_compaction' },
                { text: '压缩恢复', link: '/trpc-agent-go/examples/20-advanced-features/context_compaction_recovery' },
                { text: '引导控制', link: '/trpc-agent-go/examples/20-advanced-features/steer' },
                { text: '思考模式', link: '/trpc-agent-go/examples/20-advanced-features/thinking' },
                { text: '时间感知', link: '/trpc-agent-go/examples/20-advanced-features/timeaware' },
                { text: '摘要', link: '/trpc-agent-go/examples/20-advanced-features/summary' },
                { text: '裁剪', link: '/trpc-agent-go/examples/20-advanced-features/tailor' },
                { text: 'ReAct 推理', link: '/trpc-agent-go/examples/20-advanced-features/react' },
                { text: '限制配置', link: '/trpc-agent-go/examples/20-advanced-features/max_limits' },
                { text: '文件输入', link: '/trpc-agent-go/examples/20-advanced-features/fileinput' },
                { text: '工作空间 IO', link: '/trpc-agent-go/examples/20-advanced-features/workspace_io' },
                { text: '内置浏览器', link: '/trpc-agent-go/examples/20-advanced-features/builtinexplorer' },
                { text: '消息重写', link: '/trpc-agent-go/examples/20-advanced-features/usermessagerewriter' },
                { text: '插件系统', link: '/trpc-agent-go/examples/20-advanced-features/plugin' },
                { text: '任务运行', link: '/trpc-agent-go/examples/20-advanced-features/taskrun' },
                { text: 'Todo', link: '/trpc-agent-go/examples/20-advanced-features/todo' },
                { text: 'Artifact', link: '/trpc-agent-go/examples/20-advanced-features/artifact' },
              ]
            },
          ]
        }
